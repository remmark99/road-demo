...
### Безопасный парк
- Инциденты и безопасность: рейтинг безопасности, все инциденты, критические в работе, открытые инциденты, проблемные зоны, среднее время реакции, очередь управленческих действий.
