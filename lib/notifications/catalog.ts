...
export const NOTIFICATION_EVENT_TYPES: readonly NotificationEventTypeOption[] = [
  ...
  option("alerts", "stops", "camera_offline", "Камера не в сети"),
  option("alerts", "stops", "camera_online", "Камера снова в сети"),
  option("controller_alerts", "stops", "controller_offline", "Контроллер не на связи"),
