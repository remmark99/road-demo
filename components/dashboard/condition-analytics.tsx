...
export function ConditionAnalytics() {
    ...
    const readingsFiltered = useMemo(() => {
        return filterByDay(filterSelectedStops(conditionReadingsData, selectedStops), timeRange)
    }, [timeRange, selectedStops])

    const alertsFiltered = useMemo(() => {
        return filterByDay(filterSelectedStops(conditionAlertsData, selectedStops), timeRange)
    }, [timeRange, selectedStops])
